...
_m_player_agent_forearm_length = 4;
_m_player_agent_head_to_elbow = 15;
_m_player_agent_leg_length = 8;
_m_player_agent_height = 25;
_m_player_spy_diameter = 8.5;
_m_player_spy_height = 12.25;
_m_player_tracker_diameter = 15.5;
...
_m_player_hooks_neck_width = 10;
_m_player_hooks_body_length = 17;
_m_player_hooks_toe_length = 11;
_m_player_hooks_width = 19;
_m_player_hooks_thickness = 2.1;
_m_player_atomics_length = 38;
